...
function prev(){
      ...
      ctx.fill();
      ctx.fillStyle = "#fff";
      ctx.fillText("Bar do Noma", 10, 25);
      ctx.font = "16px Arial";
      ctx.fillText("Sócio", 15, 45);
      ...
      ctx.fillText("N° " + resp.toFixed(8), 110, 165);
...
download.addEventListener("click", function(){
  ...
  if(window.navigator.msSaveBlob) {
    ...
    window.navigator.msSaveBlob(canvas.msToBlob(), "carteirinha.png");
  } else {
